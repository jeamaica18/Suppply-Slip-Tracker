...
<body>
    <div class="container-wrapper">
        <div class="login-container">
            <h4 class="mb-3" style="color: #41779C; font-weight: bolder; text-xl text-[#3B5166] uppercase; font-size: 25px; font-weight: 700;">LOG IN YOUR ACCOUNT</h4>
    ...
    <style>
        ...
        .alert-container {
            ...
            width: 50%; /* Adjust width to make it thinner */
            max-width: 300px; /* Ensures it doesn't stretch too much on large screens */
            text-align: center; 
        }
        .alert{
            padding: 1px; /* Adjust padding to make it more compact */
